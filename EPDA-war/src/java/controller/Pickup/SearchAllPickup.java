 ...
 * @author cwy
 */
@WebServlet(name = "SearchAllPickup", urlPatterns = {"/SearchAllPickup"})
public class SearchAllPickup extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Pickup> pickupList = pickupFacade.findAll();
        
        try (PrintWriter out = response.getWriter()) {
            if(pickupList != null){
                request.setAttribute("pickupList", pickupList);
                request.getRequestDispatcher("searchPickup.jsp").include(request, response);
            } else{
