    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            if(found != null){
                ...
                out.println("<br><br><br>Username has been used!");
            } else{
                Staff x = new Staff(username,password,name,gender,phone,ic,email,address,role,status);
                staffFacade.create(x);
                request.getRequestDispatcher("SearchAllStaff").include(request, response);
            }
        }
